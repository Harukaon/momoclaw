const zhCN: Record<string, string> = {
  ...
  "config.base_url_hint": "留空则使用官方地址",
  "config.api_type": "API 类型",
  "config.api_type_auto": "内置服务商已自动设置",
  ...
  "config.oauth_authenticated": "已认证",
  "config.oauth_not_authenticated": "未认证",
  "config.oauth_cli_hint": "通过 CLI /login 命令登录",
  "config.oauth_expires": "过期时间",
  "config.optional": "可选",
